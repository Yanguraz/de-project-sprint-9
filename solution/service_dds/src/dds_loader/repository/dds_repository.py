...
class DdsRepository:
    ...
    def h_user_insert(self, h_user_pk: str, user_id: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'h_user_pk': h_user_pk, 'user_id': user_id, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def h_product_insert(self, h_product_pk: str, product_id: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'h_product_pk': h_product_pk, 'product_id': product_id, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def h_category_insert(self, h_category_pk: str, category_name: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'h_category_pk': h_category_pk, 'category_name': category_name, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def h_restaurant_insert(self, h_restaurant_pk: str, restaurant_id: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'h_restaurant_pk': h_restaurant_pk, 'restaurant_id': restaurant_id, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def h_order_insert(self, h_order_pk: str, order_id: str, order_dt: datetime, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'h_order_pk': h_order_pk, 'order_id': order_id, 'load_dt': load_dt, 'order_dt': order_dt, 'load_src': load_src})
    ...
    def l_order_product_insert(self, hk_order_product_pk: str, h_order_pk: str, h_product_pk: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'hk_order_product_pk': hk_order_product_pk, 'h_order_pk': h_order_pk, 'h_product_pk': h_product_pk, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def l_product_restaurant_insert(self, hk_product_restaurant_pk: str, h_product_pk: str, h_restaurant_pk: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'hk_product_restaurant_pk': hk_product_restaurant_pk, 'h_product_pk': h_product_pk, 'h_restaurant_pk': h_restaurant_pk, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def l_product_category_insert(self, hk_product_category_pk: str, h_product_pk: str, h_category_pk: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'hk_product_category_pk': hk_product_category_pk, 'h_product_pk': h_product_pk, 'h_category_pk': h_category_pk, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def l_order_user_insert(self, hk_order_user_pk: str, h_order_pk: str, h_user_pk: str, load_dt: datetime, load_src: str) -> None:
        ...
        """
        self._execute_query(query, {'hk_order_user_pk': hk_order_user_pk, 'h_order_pk': h_order_pk, 'h_user_pk': h_user_pk, 'load_dt': load_dt, 'load_src': load_src})
    ...
    def s_user_names_insert(self, h_user_pk: str, username: str, userlogin: str, load_dt: datetime, load_src: str, hk_user_names_hashdiff: str) -> None:
        ...
        """
        self._execute_query(query, {'h_user_pk': h_user_pk, 'username': username, 'userlogin': userlogin, 'load_dt': load_dt, 'load_src': load_src, 'hk_user_names_hashdiff': hk_user_names_hashdiff})
    ...
    def s_product_names_insert(self, h_product_pk: str, name: str, load_dt: datetime, load_src: str, hk_product_names_hashdiff: str) -> None:
        ...
        """
        self._execute_query(query, {'h_product_pk': h_product_pk, 'name': name, 'load_dt': load_dt, 'load_src': load_src, 'hk_product_names_hashdiff': hk_product_names_hashdiff})
    ...
    def s_restaurant_names_insert(self, h_restaurant_pk: str, name: str, load_dt: datetime, load_src: str, hk_restaurant_names_hashdiff: str) -> None:
        ...
        """
        self._execute_query(query, {'h_restaurant_pk': h_restaurant_pk, 'name': name, 'load_dt': load_dt, 'load_src': load_src, 'hk_restaurant_names_hashdiff': hk_restaurant_names_hashdiff})
    ...
    def s_order_cost_insert(self, h_order_pk: str, cost: float, payment: float, load_dt: datetime, load_src: str, hk_order_cost_hashdiff: str) -> None:
        ...
        """
        self._execute_query(query, {'h_order_pk': h_order_pk, 'cost': cost, 'payment': payment, 'load_dt': load_dt, 'load_src': load_src, 'hk_order_cost_hashdiff': hk_order_cost_hashdiff})
    ...
    def s_order_status_insert(self, h_order_pk: str, status: str, load_dt: datetime, load_src: str, hk_order_status_hashdiff: str) -> None:
        ...
        """
        self._execute_query(query, {'h_order_pk': h_order_pk, 'status': status, 'load_dt': load_dt, 'load_src': load_src, 'hk_order_status_hashdiff': hk_order_status_hashdiff})
